...
#ifndef LUALOOKATITEMSCRIPT_HH
#define LUALOOKATITEMSCRIPT_HH

class LuaLookAtItemScript {
	public:
		...
		bool lookAtItem(Character *character, const ScriptItem &item) { return false; }
};
